...
| Comandos                                                        | O que faz?                                            |
|-----------------------------------------------------------------|-------------------------------------------------------|
| [git add]("#git-add")                                           | Colocar arquivos na fase de stagging                  |
| [git status/log]("#git-status-e-log")                           | Ver o status das suas alterações                      |
| [git commit]("#git-commit")                                     | Manipular alterações pós stagging                     |
| [git push]("#git-push")                                         | Enviar alterações para o repositório remoto           |
| [git pull]("#git-pull")                                         | Baixar informações do repositório remoto para o local |
| [git fetch]("#git-fetch")                                       | Atualizar referências                                 |
| [git branch/checkout/rebase]("#git-branch-e-checkout-e-rebase") | Manipulação de branches e navegação entre branches    |
| [git mv/rm]("#git-mv-e-rm")                                     | Trabalhando com arquivos e diretórios                 |
| [git merge]("#git-merge")                                       | Fazendo merge entre branches                          |
| [git revert]("#git-revert")                                     | Como desfazer alterações                              |
| [other commands]("#others")                                     | Mais comandos úteis                                   |
...
## git push
### Operações para subir informações para o Github
...
## git pull
### Operações para baixar informações do repositório no Github para o repositório local
...
## git branch e checkout e rebase
### Manipulação de branches e navegação entre branches
...
## git mv e rm
### Trabalhando com arquivos e diretórios com git
...
## git revert
### Operações para desfazer alterações
